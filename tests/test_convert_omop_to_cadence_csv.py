...
def test_attributes_datatypes():
	table_attributes = convert_omop_to_cadence_csv.convert_omop_to_cadence(conn, generate_query_csv.attributes()).arrow()
...
def test_events_datatypes():
	table_events = convert_omop_to_cadence_csv.convert_omop_to_cadence(conn, generate_query_csv.events()).arrow()
